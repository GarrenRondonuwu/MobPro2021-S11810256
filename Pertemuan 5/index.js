...
// let arrJohn = ["Garren", "Axel Arie", 33, true, scores];

// console.log(arrGarren[4][1]);
...
// console.log(objGarren.firstName); //dot notation
// console.log(objGarren["scores"][1]); //bracket notation
